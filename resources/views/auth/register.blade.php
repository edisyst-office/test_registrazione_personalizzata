<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-jet-label for="licence_number" value="{{ __('Licence Number: min 5 digits') }}" />
                <x-jet-input id="licence_number" class="block mt-1 w-full" type="text" name="licence_number" :value="old('licence_number')" required />
            </div>
            <div class="mt-4">
